...
int main(int argc, char** argv) {
	...
	fd_set sockets;
	FD_ZERO(&sockets); // Just incase this isn't already zero, just make sure it is
...
//                // TODO: probably gonna mess up at end of file because of > 0
